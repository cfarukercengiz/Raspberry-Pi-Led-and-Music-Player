...
consumer_key="" #Twitter apinizin consumer keyiniz
consumer_secret="" #Twitter apinizin consumer_secret keyiniz
access_token=""#Apinizin tokeni
access_token_secret=""#Apinin token secreti
